...
path_openssl := external/libjingle/third_party/openssl/openssl
...
local_c_includes := \
	$(path_openssl) \
	$(path_openssl)/crypto/asn1 \
	$(path_openssl)/crypto/evp \
	$(path_openssl)/crypto/modes \
	$(path_openssl)/include \
	$(path_openssl)/include/openssl \
	external/zlib
